...
backend:
  - task: "Google OAuth Authentication System"
    ...
    status_history:
      ...
      - working: true
        agent: "main"
        comment: "CORS CORREGIDO ✅ - Actualizado /app/backend/.env con CORS_ORIGINS='https://compliance-audit-ai-1.preview.emergentagent.com,http://localhost:3000'. Backend reiniciado. Verificado con screenshot: no más errores CORS, /api/auth/check responde 200 OK."
      - working: true
        agent: "user"
